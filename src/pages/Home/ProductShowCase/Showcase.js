...
const products = [
  ...
  { image: CalbocinK27,    category: "Bone Health",                   title: "Calbocin® K27",          composition: "Calcitriol 25 mcg + Calcium Citrate 1000 mg + Methylcobalamin 1500 mcg + Vitamin K2 7.5 mcg + Folic Acid 1.5 mg + Zinc 7.5 mg",                           description: "Advanced bone health formula with active vitamin D3, calcium, and essential co-nutrients for maximum absorption." },
  { image: DexorocinSyrup, category: "Hematinic",                     title: "Dexorocin® B12 Syrup",   composition: "Ferric Ammonium Citrate 150 mg + Cyanocobalamin 7.5 mg + Folic Acid 0.5 mg / 5 ml",                                                                       description: "Iron supplement with vitamin B12 and folic acid for effective anaemia treatment and red blood cell support." },
  ...
  { image: Flexocin,       category: "Analgesic & Anti-inflammatory", title: "Flexocin® SP Tablets",   composition: "Aceclofenac 60 mg + Paracetamol 325 mg + Serratiopeptidase 15 mg",                                                                                       description: "Triple-action pain relief combining anti-inflammatory, analgesic, and enzyme therapy for musculoskeletal pain." },
  ...
  { image: Zivocin,        category: "Immunity Booster",              title: "Zivocin™ Tablets",        composition: "Zinc 50 mg + Biotin 10 mg + Vitamin C 500 mg + Antioxidants",                                                                                           description: "Complete immunity and skin health supplement packed with antioxidants for daily cellular protection." },
  ...
  { image: Respicin,       category: "Respiratory",                   title: "Respicin-Acti Syrup",     composition: "Ambroxol 30 mg + Guaiphenesin 50 mg + Terbutaline 1.25 mg / 5 ml",                                                                                      description: "Triple-action cough syrup combining mucolytic, expectorant, and bronchodilator for productive cough relief." },
  { image: Respicin,       category: "Respiratory",                   title: "Respicin-Dx Syrup",       composition: "Dextromethorphan 10 mg + Chlorpheniramine 2 mg + Phenylephrine 5 mg / 5 ml",                                                                            description: "Dry cough formula with decongestant and antihistamine action for upper respiratory tract relief." },
  { image: Respicin,       category: "Respiratory",                   title: "Respicin-LS Syrup",       composition: "Levosalbutamol 1 mg + Ambroxol 30 mg + Guaiphenesin 50 mg / 5 ml",                                                                                      description: "Bronchodilator with mucolytic combination for asthma management and chronic bronchitis." },
